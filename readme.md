...
![ModelA](images/ModelA.png)

## Model B
Model B is a Convolutional Neural Network with 3 feature maps as inputs. Two feature maps highlight the interaural cues and level differences between left and right ear, 
...
as well as tested on real world data generated by a M-Track Duo Audio Processor and two connected microphones that where placed inside a clay head. The largest training set had 44x30x0.8 datapoints, the smallest 18x30x0.8 datapoints (corresponds to SamplesPerDirectionXDirectionsXTrainingValidationWeight).
Both models converge for all environments (above 95 percent acuracy). Tests on live generated data are ongoing.
...
![Field Test](images/field_test.jpeg)