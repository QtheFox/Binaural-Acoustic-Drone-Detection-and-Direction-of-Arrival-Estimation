...
import time
import torch
from Step_5_training_modelA import SoundDirectionCNN, SoundDirectionDataset
...
def run_single_inference():
    ...
    # Add batch dim
    left_long  = left_long.unsqueeze(0)
    right_long = right_long.unsqueeze(0)
    left_short = left_short.unsqueeze(0)
    right_short = right_short.unsqueeze(0)
    ...
    with torch.no_grad():
        outputs = model(left_long, right_long, left_short, right_short)
